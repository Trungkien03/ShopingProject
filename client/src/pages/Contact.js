                  ...
                  <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                    <form>
                      ...
                      <div className="mb-6 inline-block min-h-[1.5rem] justify-center pl-[1.5rem] md:flex">
                        ...
                        />
                        <label
                          className="inline-block pl-[0.15rem] hover:cursor-pointer hover:text-gray-300 transition-all"
                      ...
                      <button
                        ...
                        className="mb-6 inline-block w-full rounded bg-primary px-6 
                        pt-2.5 pb-2 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] 
                        transition duration-150 ease-in-out hover:bg-primary-600 hover:bg-gray-500
